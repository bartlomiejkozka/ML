...
class GiftAdvisorApp:
    def __init__(self, root):
        ...
        self.label = ttk.Label(
            root, text="Wprowadź dane osoby, dla której szukasz prezentu:")
        ...
        self.sex_combobox = ttk.Combobox(
            root, textvariable=self.sex_var, values=[
                "Mężczyzna", "Kobieta", ""])
        ...
        self.relationship_label.grid(
            row=3, column=0, padx=10, pady=10, sticky="w")
        self.relationship_entry = ttk.Entry(root, width=30)
        self.relationship_entry.grid(
        ...
        self.hobbies_label = ttk.Label(
            root, text="Zainteresowania (wymień po przecinku):")
    ...
    def submit(self):
        ...
        self.result_text.insert(
            tk.END, f"Zainteresowania: {', '.join(hobbies)}\n")
